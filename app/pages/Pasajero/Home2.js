...
import { View, Text, StyleSheet, ActivityIndicator, Alert, TextInput, TouchableOpacity, SafeAreaView, StatusBar, Image } from 'react-native';
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.statsCard}>
        ...
        <View style={styles.statItem}>
          ...
          <Text style={styles.statValue}>{TicketDolarLoad?  (<ActivityIndicator size="small" color="#0022ffff" />):`Bs. ${TicketDolar}`}</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  routeCard: {
    backgroundColor: 'white',
    marginHorizontal: 20,
    marginTop: -40, // Traslapa con el fondo azul
    borderRadius: 15,
    padding: 15,
    // Sombras
    elevation: 15,
